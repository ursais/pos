            ...
            async _getAddProductOptions(product, base_code) {
                ...
                if (_.some(product.attribute_line_ids, (id) => id in this.env.pos.attributes_by_ptal_id)) {
                    ...
                    if (confirmed) {
                        ...
                        product_no_variant_attribute_value_ids = payload.product_no_variant_attribute_value_ids;
                    } else {
                        return;
                    }
                }
                ...
                return { draftPackLotLines, quantity: weight, description, price_extra, product_no_variant_attribute_value_ids };
            }
        };
